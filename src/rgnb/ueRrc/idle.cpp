...
void UeRrcTask::performCellSelection()
{
    ...
    if (selectedCell != lastCell.cellId)
    {
        ...
        m_base->ueRlsTask->push(std::move(w1));
...
// Cell Selection: identify suitable cell with strongest signal
