...
void NasMm::handleActiveCellChange(const Tai &prevTai)
{
    ...
    // if the TAI has changed: either a new plmn or a new tracking area code (tac)
    ...
    // plmn has changed, aka new network operator, not only a change of tracking area within the network of the same operator
