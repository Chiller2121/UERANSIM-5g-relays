...
static nr::rgnb::RGnbGnbConfig *g_refConfig = nullptr;
static std::unordered_map<std::string, nr::rgnb::RGNodeB *> g_rgnbMap{};
...
static nr::rgnb::RGnbGnbConfig *ReadConfigYaml()
{
...
int main(int argc, char **argv)
{
    ...
    auto *rgnb = new nr::rgnb::RGNodeB(g_refConfig, nullptr, g_cliRespTask);
    g_rgnbMap[g_refConfig->name] = rgnb;
